...
public class CustomPopWindowBack implements PopupWindow.OnDismissListener {
    ...
    private CustomPopWindowBack(Context context) {
        mContext = context;
    }
     ...
     * @return
     */
    public CustomPopWindowBack showAsDropDown(View anchor, int xOff, int yOff) {
    ...
    public CustomPopWindowBack showAsDropDown(View anchor) {
        if (mPopupWindow != null) {
    ...
    public CustomPopWindowBack showAsDropDown(View anchor, int xOff, int yOff, int gravity) {
        if (mPopupWindow != null) {
     ...
     * @return
     */
    public CustomPopWindowBack showAtLocation(View parent, int gravity, int x, int y) {
        if (mPopupWindow != null) {
    ...
    public static class PopupWindowBuilder {
        private CustomPopWindowBack mCustomPopWindow;

        public PopupWindowBuilder(Context context) {
            mCustomPopWindow = new CustomPopWindowBack(context);
        }
        ...
        public CustomPopWindowBack create() {
            //构建PopWindow
